...
public class FindPage {
	...
	public FindPage(Integer oid, String moduleName, String oclass, Integer stateMent, String androidUrl, String iosUrl,
			String imgageUrl, String create_time, Integer orderid) {
		super();
		this.oid = oid;
